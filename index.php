...
<h1> No cars available :( </h1>
        ...
        <div class="w3-row w3-padding-32 w3-section">
            ...
            <div class="w3-col m8 w3-panel">
                <div class="w3-large w3-margin-bottom">
                    <i class="fa fa-map-marker fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i>  IU, Pakistan<br>
                    <i class="fa fa-phone fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Phone: +92 123456789<br>
                    <i class="fa fa-envelope fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Email: mail@iqra.xyz<br>
                </div>
                <p>New to  ? Drop Your Details and Leave it on us We'll Revert</p>
    ...
    <script>
        function myMap() {
            myCenter = new google.maps.LatLng(24.8607, 67.0011);
            var mapOptions = {
                center: myCenter,
                zoom: 12,
                scrollwheel: true,
