...
<div class="container" style="margin-top: 65px;" >
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <div ng-switch-default>
                ...
                <!-- </div>    -->
                    ...
                    <!-- <div class="form-group"> -->
                <h5>Fare: <?php echo("Rs." . $ac_price . "/km and Rs." . $ac_price_per_day . "/day");?><h5>    
                <!-- </div>    -->
                     </div>
                     <div ng-switch-when="non_ac">
                     <!-- <div class="form-group"> -->
                <h5>Fare: <?php echo("Rs." . $non_ac_price . "/km and Rs." . $non_ac_price_per_day . "/day");?><h5>    
                <!-- </div>   -->
                     </div>
        </div>
      ...
      <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6><strong>Kindly Note:</strong> You will be charged <span class="text-danger">Rs.200/-</span> for each day after the due date.</h6>
        </div>
    </div>
